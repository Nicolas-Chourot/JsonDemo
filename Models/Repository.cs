...
namespace JsonDAL
{
    ...
    public class Repository<T>
    {
        ...
        // Numéro de serie des données utilisé par MarkHasChanged
        ...
        // Init : reçoit le chemin d'accès absolu du fichier JSON
        ...
        // indiquer que les données viennent d'être modifiées
